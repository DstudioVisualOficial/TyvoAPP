...
import 'driver_register_cotizacion_taximetroxpuntos_controller.dart';

  class DriverRegisterCotizacionTaximetroXPuntosPage extends StatefulWidget {
  @override
  _DriverRegisterCotizacionTaximetroXPuntosPageState createState() => _DriverRegisterCotizacionTaximetroXPuntosPageState();
}

class _DriverRegisterCotizacionTaximetroXPuntosPageState extends State<DriverRegisterCotizacionTaximetroXPuntosPage> {

  DriverRegisterCotizacionTaximetroXPuntosController _con = new DriverRegisterCotizacionTaximetroXPuntosController();
  @override
  void initState() {
  ...
  Future<bool> _onBackPressed() async {
    ...
    displaySnackBar("Registre la Cotizacion Solicitada.");
  }
